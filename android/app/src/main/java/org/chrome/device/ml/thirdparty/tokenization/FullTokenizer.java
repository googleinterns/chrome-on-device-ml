...
==============================================================================*/
package org.chrome.device.ml.thirdparty.tokenization;
...
/**
 * A java realization of Bert tokenization. Original python code: https://github
 * .com/google-research/bert/blob/master/tokenization.py
 * runs full tokenization to tokenize a String into split subtokens or ids.
 */
